...
Source0  : https://github.com/PJK/libcbor/archive/v0.11.0/libcbor-0.11.0.tar.gz
...
%prep
%setup -q -n libcbor-0.11.0
cd %{_builddir}/libcbor-0.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707146180
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcbor.so.0.11.0
