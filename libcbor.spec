...
Version  : 0.10.0
Release  : 2
URL      : https://github.com/PJK/libcbor/archive/v0.10.0/libcbor-0.10.0.tar.gz
Source0  : https://github.com/PJK/libcbor/archive/v0.10.0/libcbor-0.10.0.tar.gz
...
%prep
%setup -q -n libcbor-0.10.0
cd %{_builddir}/libcbor-0.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672359273
mkdir -p clr-build
pushd clr-build
