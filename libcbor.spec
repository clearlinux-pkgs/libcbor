...
Version  : 0.9.0
Release  : 1
URL      : https://github.com/PJK/libcbor/archive/refs/tags/v0.9.0.tar.gz
Source0  : https://github.com/PJK/libcbor/archive/refs/tags/v0.9.0.tar.gz
...
%prep
%setup -q -n libcbor-0.9.0
cd %{_builddir}/libcbor-0.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671550724
mkdir -p clr-build
pushd clr-build
