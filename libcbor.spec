...
Version  : 0.10.1
Release  : 3
URL      : https://github.com/PJK/libcbor/archive/v0.10.1/libcbor-0.10.1.tar.gz
Source0  : https://github.com/PJK/libcbor/archive/v0.10.1/libcbor-0.10.1.tar.gz
...
%prep
%setup -q -n libcbor-0.10.1
cd %{_builddir}/libcbor-0.10.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672682923
mkdir -p clr-build
pushd clr-build
